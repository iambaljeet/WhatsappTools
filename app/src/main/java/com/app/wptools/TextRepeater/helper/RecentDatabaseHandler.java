package com.app.wptools.TextRepeater.helper;
...
public class RecentDatabaseHandler extends SQLiteOpenHelper {
    ...
    // Contacts table name
    private static final String TABLE_REP_TEXT = "repeated_text_recent";

    // Contacts Table Columns names
    private static final String KEY_ID = "id";
    private static final String KEY_REP_TEXT = "rep_text";

    public RecentDatabaseHandler(Context context) {
